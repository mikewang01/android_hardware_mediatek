...
//please use this macro,or wifi print error message on running,add by dg
#define CFG_HAVE_SERIAL_H  1   


#ifdef CFG_HAVE_SERIAL_H
#include "../../../kernel/iTop4412_Kernel_3.0/include/linux/serial.h" /* struct serial_struct  */
...
#define  WMT_PLAT_APEX  1  //add by dg for debug
...
int main(int argc, char *argv[])
{
    ...
    printf("iTOP4412 wmt_launcher  porting  version .....");
