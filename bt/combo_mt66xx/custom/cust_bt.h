...
#define  MTK_COMBO_SUPPORT   //add by dg for debug bt on mt6620
...
/* BAUDRATE */
#define CUST_BT_BAUD_RATE   4000000 /* not controlled by BT directly */
#else
/* SERIAL PORT */
#define CUST_BT_SERIAL_PORT "/dev/ttySAC0"
/* BAUDRATE */
